...
{
    public class ConfiguracaoGruposRepositorio : RepositorioBase<ConfiguracaoGrupos>, IConfiguracaoGruposRepositorio
    {

        //private const string SQL_SELECT_JOIN = @"
        //    SELECT 
        //        rt.rate_group as CodigoGrupo, 
        //        isnull(og.num_ordena,0) as Ordenacao,
        ...
        //    FROM rate_group rt
        //     LEFT JOIN  res_sobconsulta_ordena_grupo og
        //     ON rt.rate_group = og.rate_group
        //        LEFT JOIN res_sobconsulta_upgrade u
        //        ON u.rate_group_ordena = og.rate_group

        //    WHERE rt.idc_tarifario = 1";
        ...
        public ConfiguracaoGruposRepositorio() : base(ConexaoBanco.TipoConexao.Aguia)
        {
        }
