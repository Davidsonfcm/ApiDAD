...
{
    public class ReservaDto : DtoBase<Atendimento.SobConsulta.Entidades.Reserva, ReservaDto>
    {
        ...
        public List<HorarioFuncionamentoDto> HorarioFuncionamentoAgenciaRetirada { get; set; }
        ...
        public TelefoneClienteDto ContatoCliente { get; set; }
        ...
        public InformacoesUsuarioDto SupervisorAgenciaRetirada { get; set; }
        public InformacoesUsuarioDto RegionalAgenciaRetirada { get; set; }
    }
}
